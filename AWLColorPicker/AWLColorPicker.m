...
+ (BOOL)awl_loadNibNamed:(NSString*)aNibName owner:(id)anOwner;
@end
...
- (NSView *)provideNewView:(BOOL)initialRequest {
    if (initialRequest) {
        ...
        if (![NSBundle awl_loadNibNamed:nibName owner:self]) {
...
+ (BOOL)awl_loadNibNamed:(NSString*)aNibName owner:(id)anOwner {
    ...
    if ([[NSBundle mainBundle] respondsToSelector:@selector(loadNibNamed:owner:topLevelObjects:)]) {
        ...
        return [[NSBundle mainBundle] loadNibNamed:aNibName
                                             owner:anOwner
                                   topLevelObjects:nil];
    } else {
